...
public class CameraEdgeCollision : MonoBehaviour
{
  ...
  public void AddColliderOnCamera()
  {
    ...
    var edgeColliderTop = gameObject.AddComponent<EdgeCollider2D>();
    var edgeColliderBottom = gameObject.AddComponent<EdgeCollider2D>();
    ...
    var edgePointsTop = new[] { leftTop, rightTop };
    var edgePointsBottom = new[] { leftBottom, rightBottom };

    // Adding edge points
    edgeColliderTop.points = edgePointsTop;
    edgeColliderBottom.points = edgePointsBottom;
  }
}